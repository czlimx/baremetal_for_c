...
set(GCC_FLAGS     "-fno-builtin -fdata-sections -ffunction-sections -fno-exceptions -mno-unaligned-access")
...
set(LDD_FLAGS     "-fno-builtin -ffreestanding -nostartfiles -Wl,--gc-sections -Wl,--print-memory-usage")
